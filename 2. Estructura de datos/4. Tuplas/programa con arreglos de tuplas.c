...
int mayor(int valor1, int valor2){ 	//parte donde halla el mayor de dos numeros
    return valor1 > valor2 ? valor1 : valor2;
}

int suma(int valor1, int valor2){  //Parte donde suma los dos numeros
    return valor1 + valor2;
}

int ejecutar_operacion(struct Pares *tupla){ //parte donde obtiene los PARES
